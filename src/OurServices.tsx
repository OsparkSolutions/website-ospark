...
export const OurServices = () =>{
    return(
        <div>
            <h1>Our Services</h1>
            <OurServicesComponent title = 'Mobile & Web & Gaming App Development' uri={levert}>
...
const OurServicesComponent = (props: PropsWithChildren<OurServicesComponent>) => {
    ...
    let imageClass = windowSize.deviceSize <= DeviceSize.medium ? styles.mainSectionImages : mergeStyles({float: props.isImageRight ? 'right' : 'left'});
    let textClass = windowSize.deviceSize <= DeviceSize.medium ? styles.mainSectionTitle : undefined;

    return(
        <div className = {mergeStyles({clear: 'both'})}>
