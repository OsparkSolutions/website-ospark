...
export const OurServices = () =>{
    return(
        <div>
            <h1 className={styles.sectionHeader}>Our Services</h1>
            <OurServicesComponent title = 'Mobile & Web & Gaming App Development' uri={reporting}>
            ...
            <OurServicesComponent title = 'Websites, Portals & UI/UX Design' uri = {levert} isImageRight>
                We embrace the new app philosophy (HTML5, Javascript, Node JS, CSS) and build platform agnostic app logic. This allows us to build iOS, Android, web, and desktop apps with mostly a single code base. Basically, that just means we build apps quickly and at a lower cost. Let us know how we can help you with your app development needs.
            </OurServicesComponent>
            <OurServicesComponent title = 'Reporting, BI & Data Warehousing' uri = {levert}>
            We embrace the new app philosophy (HTML5, Javascript, Node JS, CSS) and build platform agnostic app logic. This allows us to build iOS, Android, web, and desktop apps with mostly a single code base. Basically, that just means we build apps quickly and at a lower cost. Let us know how we can help you with your app development needs.
            </OurServicesComponent>
        </div>
    );
...
const OurServicesComponent = (props: PropsWithChildren<OurServicesComponent>) => {
    ...
    let imageClass = windowSize.deviceSize <= DeviceSize.medium ? styles.mainSectionImages : mergeStyles({float: props.isImageRight ? 'right' : 'left', width: '30%', display:'flex',alignItems: 'center', flexDirection:'column'});
    let textClass = windowSize.deviceSize <= DeviceSize.medium ? styles.mainSectionTitle : undefined;

    return(
        <div className = {mergeStyles({
            clear: 'both',
        })}>
            <img className={imageClass} src = {props.uri}/>
